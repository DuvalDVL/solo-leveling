...
const itemsData = [
    ...
    { id: "potion_soin_c", nom: "Potion de Soin Superieure", type: "consommable", rang: "C", image: "assets/items/consommables/potion_soin.png", stackable: true, description: "Restaure 350 PV.", effet: { type: "soin_pv", valeur: 350 } },
    ...
    { id: "potion_mana_c", nom: "Fiole de Mana Superieure", type: "consommable", rang: "C", image: "assets/items/consommables/potion_mana.png", stackable: true, description: "Restaure 180 PM.", effet: { type: "soin_pm", valeur: 180 } },
    ...
    { id: "bandages_medicaux", nom: "Bandages Medicaux", type: "consommable", rang: "E", image: "assets/items/consommables/bandages.png", stackable: true, description: "Supprime l'alteration Saignement.", effet: { type: "soin_statut", cible: "saignement" } },
    { id: "antidote_universel", nom: "Antidote Universel", type: "consommable", rang: "D", image: "assets/items/consommables/antidote.png", stackable: true, description: "Supprime l'alteration Poison.", effet: { type: "soin_statut", cible: "poison" } },
    { id: "cristal_teleportation", nom: "Cristal de Teleportation", type: "consommable", rang: "B", image: "assets/items/consommables/cristal_teleportation.png", stackable: true, description: "Permet de fuir un donjon instantanement. Objet tres rare.", effet: { type: "fuite_instantanee" } },
    { id: "elixir_vie", nom: "Elixir de Vie", type: "consommable", rang: "S", image: "assets/items/legendaire/elixir_vie.png", stackable: true, description: "Objet legendaire de la Vitrine du Systeme. Guerit les blessures permanentes d'un allie ou accorde un bonus definitif de Vitalite.", effet: { type: "guerison_permanente_ou_bonus_vitalite" } },
    ...
    { id: "cristal_mana_c", nom: "Cristal de Mana Vibrant", type: "materiau", rang: "C", image: "assets/items/materiaux/cristal_mana.png", stackable: true, description: "Cristal charge d'une energie palpable." },
    { id: "cristal_mana_b", nom: "Cristal de Mana Condense", type: "materiau", rang: "B", image: "assets/items/materiaux/cristal_mana.png", stackable: true, description: "Rare et tres recherche des alchimistes." },
    ...
    { id: "cristal_mana_s", nom: "Cristal de Mana Absolu", type: "materiau", rang: "S", image: "assets/items/materiaux/cristal_mana.png", stackable: true, description: "Extremement rare, loot de boss de haut rang uniquement." },
    ...
    { id: "pierre_essence", nom: "Pierre d'Essence Pure", type: "special", rang: "S", image: "assets/items/special/pierre_essence.png", stackable: true, description: "Cristal d'ame extremement rare. Monnaie de la Boutique du Systeme, loot de boss uniquement." },
    ...
    { id: "cle_donjon_s", nom: "La Cle S (Heritage)", type: "special", rang: "S", image: "assets/items/legendaire/cle_s.png", stackable: false, description: "Objet unique scenarise. Ouvre le donjon final et declenche l'Ascension de Monarque.", effet: { type: "ouvre_donjon", rang: "S", cible: "temple_monarque" } },

    { id: "faux_papiers_identite", nom: "Faux Papiers d'Identite", type: "special", rang: "C", image: "assets/items/special/faux_papiers.png", stackable: false, description: "Achetes au Marche Noir. Permettent de contourner un test de Rang.", effet: { type: "contourne_test_rang" } },
    { id: "dissimulateur_mana", nom: "Dissimulateur de Mana", type: "accessoire", rang: "B", image: "assets/items/accessoires/dissimulateur_mana.png", stackable: false, description: "Permet de cacher sa veritable puissance aux Inspecteurs de l'Association.", special: "masque_mana" },

    // ------------------------------------------
    // 3. ARMES PRINCIPALES PAR CLASSE
    // Image generique partagee par classe d'arme, liseret CSS gere par le rang
    // ------------------------------------------

    // --- Guerrier (Force) : epees / lames lourdes ---
    ...
    { id: "orbe_foudre", nom: "Orbe de Foudre", type: "arme_principale", classe: "mage", rang: "C", image: "assets/items/armes/baton_generique.png", stackable: false, description: "Une sphere crepitant d'electricite statique.", stats: { intelligence: 25 }, competence_texte: "Projeter de l'energie" },
    ...
    { id: "arbalete_elfe", nom: "Arbalete Elfe", type: "arme_principale", classe: "ranger", rang: "C", image: "assets/items/armes/arc_generique.png", stackable: false, description: "Precision redoutable a moyenne portee.", stats: { perception: 25, agilite: 5 }, competence_texte: "Tir de precision" },
    { id: "fusil_mana", nom: "Fusil a Mana", type: "arme_principale", classe: "ranger", rang: "B", image: "assets/items/armes/arc_generique.png", stackable: false, description: "Convertit le mana en projectiles concentres.", stats: { perception: 45, agilite: 10 }, competence_texte: "Tir de precision" },
    ...
    { id: "arc_arbre_monde", nom: "Arc de l'Arbre Monde", type: "arme_principale", classe: "ranger", rang: "S", image: "assets/items/legendaire/arc_arbre_monde.png", stackable: false, description: "Taille dans une branche de l'Arbre Monde lui-meme.", stats: { perception: 150, agilite: 30 }, competence_texte: "Tir Transperce-Armure" },
    ...
    // ------------------------------------------
    // 4. ARMURES (torse)
    // Trois archetypes partages entre classes pour limiter les visuels : Legere (Assassin/Ranger), Robe (Mage), Lourde (Guerrier/Tank)
    // ------------------------------------------
    ...
    { id: "armure_legere_c", nom: "Tenue d'Eclaireur", type: "armure", archetype: "legere", rang: "C", image: "assets/items/armures/legere.png", stackable: false, description: "Portee par les chasseurs specialises en infiltration.", stats: { agilite: 14, vitalite: 8 } },
    ...
    { id: "armure_robe_d", nom: "Robe Tissee de Mana", type: "armure", archetype: "robe", rang: "D", image: "assets/items/armures/robe.png", stackable: false, description: "Ameliore legerement la circulation du mana.", stats: { intelligence: 7, vitalite: 3 } },
    ...
    { id: "armure_lourde_d", nom: "Plastron de Fer", type: "armure", archetype: "lourde", rang: "D", image: "assets/items/armures/lourde.png", stackable: false, description: "Standard de l'Association pour les combattants de premiere ligne.", stats: { vitalite: 12, force: 4 } },
    ...
    { id: "armure_lourde_a", nom: "Armure du Rempart Sacre", type: "armure", archetype: "lourde", rang: "A", image: "assets/items/armures/lourde.png", stackable: false, description: "Benie contre les alterations d'etat.", stats: { vitalite: 65, force: 20 } },
    ...
    // 5. ACCESSOIRES
    // ------------------------------------------
    { id: "anneau_dissimulation", nom: "Anneau de Dissimulation", type: "accessoire", rang: "C", image: "assets/items/accessoires/anneau_generique.png", stackable: false, description: "Masque le veritable niveau de mana de son porteur. Illegal.", stats: { intelligence: 5 }, special: "masque_mana" },
    ...
    { id: "boucle_agilite", nom: "Boucle d'Oreille d'Agilite", type: "accessoire", rang: "C", image: "assets/items/accessoires/boucle_generique.png", stackable: false, description: "Un bijou leger qui affine les reflexes.", stats: { agilite: 10 } },
    ...
    // Visuel commun : eclat de pierre avec rune lumineuse coloree selon le rang
    // La version legendaire a un visuel unique (pierre noire a pointes, rune rouge)
    // ------------------------------------------
