/**
 * Banque de données des événements de Donjon (Exploration, Pièges, Combats).
 * Intègre les portails normaux, spéciaux, et les rencontres avec des humains ou monstres intelligents.
 */

const DUNGEON_EVENTS = {
    // Événements d'exploration standard (choix de salle / quitte ou double)
    standard: [
        {
            id: "goblin_ambush",
    ...
    // Événements rares (Humains renégats / Chasseurs de chasseurs)
    rogue_hunters: [
        {
    ...
    // Événements de Monstres Intelligents (Démons / Elfes des neiges)
    intelligent_monsters: [
        {
            ...
            choices: [
                ...
                },
                {
                    ...
                    statCheck: "strength",
                    difficulty: 50,
                    success: { text: "Vous triomphez de leur chef dans un duel glacial, récupérant un artéfact rare !", effect: { money: +80000, karma: +5 } },
