...
const evenementsPhase1Data = [

    {
        ...
        choix: [
            { texte: "Donner 50 Or", effet: { or: -50, karma: 0, msg: "Vous payez pour eviter les ennuis." } },
            { texte: "Vous defendre (Force min: 5)", condition: { stat: "force", min: 5 }, effet: { or: 25, pv: -10, karma: 1, msg: "Vous donnez une lecon aux voyous et recuperez leur butin." } }
        ]
    },
    {
        id: "p1_02_chat",
        ...
        choix: [
            { texte: "Aider le chat", effet: { karma: 5, agilite: 1, fatigue: 10, msg: "Le chat miaule joyeusement. Votre agilite s'ameliore legerement par cet effort." } },
    ...
    },
    {
        ...
        choix: [
            ...
            { texte: "S'allonger un moment", effet: { fatigue: -10, msg: "Vous recuperez un peu d'energie au prix de votre temps." } }
        ]
    },
    {
        id: "p1_05_colis_anonyme",
        texte: "Un colis non etiquete est depose devant votre palier. Il emet un leger bourdonnement.",
        choix: [
            { texte: "Ouvrir le colis", effet: { or: 100, pv: -15, msg: "C'etait un piege magique de bas niveau, mais il y avait de l'or a l'interieur." } },
            { texte: "Le jeter dans la benne", effet: { msg: "La prudence est mere de surete. Vous vous en debarrassez." } }
        ]
    },
    {
    ...
    },
    {
        ...
        choix: [
            ...
            { texte: "Seance legere", effet: { fatigue: 10, msg: "Une routine classique pour maintenir la forme." } }
        ]
    },
    {
        ...
        choix: [
            { texte: "Toucher la breche", effet: { intelligence: 1, pm: 10, msg: "Votre esprit effleure l'energie du Mana." } },
            { texte: "Fuir dans le salon", effet: { msg: "Vous attendez terrifie que la breche se referme d'elle-meme." } }
        ]
    },
    {
        ...
        choix: [
            ...
            { texte: "Mentir et raccrocher", effet: { karma: -2, msg: "Vous preferez garder vos deniers pour survivre." } }
        ]
    },
    {
        ...
        choix: [
            { texte: "Acheter l'information (100 Or)", effet: { or: -100, perception: 1, msg: "Vous apprenez a reperer les anomalies d'aura." } },
            { texte: "Fermer la page", effet: { msg: "Trop louche pour etre honnete." } }
        ]
    },
    {
        ...
        choix: [
            { texte: "Le coincer discretement", effet: { karma: 3, or: 40, msg: "Vous recuperez les portefeuilles voles et gardez une part." } },
            { texte: "Tourner la tete", effet: { msg: "Ce n'est pas vos oignons." } }
        ]
    },
    {
        id: "p1_12_panne_courant",
        texte: "Une coupure de courant generale plonge votre immeuble dans le noir complet pendant des heures.",
        choix: [
    ...
    },
    {
        ...
        texte: "Un medecin de rue propose des pilules miracles censees augmenter la resistance au stress des Chasseurs.",
        choix: [
    ...
    },
    {
        ...
        texte: "Au milieu de la nuit, une violente migraine vous reveille. Vos yeux brillent brievement d'une lueur bleue.",
        choix: [
            { texte: "Accepter la douleur", effet: { perception: 2, pm: 20, msg: "Votre corps s'adapte lentement a l'appel du Systeme." } },
    ...
    },
    {
        ...
        texte: "Votre superieur hierarchique direct vous humilie injustement devant vos collegues de travail.",
        choix: [
    ...
    },
    {
        ...
        choix: [
            { texte: "Fouiller la benne", effet: { item_gagne: "cristal_mana_e", msg: "Vous recuperez un cristal a moitie utilisable." } },
    ...
    },
    {
        ...
        texte: "Une vieille video d'un maitre d'arts martiaux legendaire circule sur un reseau crypte.",
        choix: [
    ...
    },
    {
        ...
        texte: "Votre voisin fait un tapage nocturne insupportable alors que vous devez recuperer pour un raid.",
        choix: [
            { texte: "Aller lui expliquer poliment la situation", effet: { karma: 1, fatigue: 5, msg: "Il s'excuse et baisse le son." } },
            { texte: "Frapper violemment a sa porte", effet: { karma: -2, force: 1, msg: "Il cede de peur. Vous avez evacue votre frustration." } }
        ]
    },
    {
    ...
    },
    {
        ...
        texte: "Dans le metro, un inconnu vous fixe intensement avec une hostilite non dissimulee.",
        choix: [
    ...
    },
    {
        ...
        texte: "Votre equipement de base commence a s'effilocher serieusement.",
        choix: [
            { texte: "Le reparer vous-meme avec du fil et de la colle", effet: { agilite: 1, msg: "Bricolage de fortune mais efficace." } },
    ...
    },
    {
        ...
        choix: [
            { texte: "Ignorer l'alerte", effet: { msg: "Ce n'est pas votre role pour l'instant." } },
    ...
    },
    {
        ...
        texte: "Un pretendu expert en esoterisme propose des cours pour eveiller ses pouvoirs de Chasseur.",
        choix: [
            { texte: "Payer la formation (50 Or)", effet: { or: -50, msg: "C'etait un charlatan pur et simple. Vous avez perdu votre argent." } },
            { texte: "Passer votre chemin", effet: { msg: "Vous reperez l'escroquerie a plein nez." } }
        ]
    },
    {
        id: "p1_30_veille_eveil",
        texte: "La pression barometrique chute brutalement. L'air devient lourd, sature d'energie magique invisible.",
        choix: [
            { texte: "Se preparer mentalement a l'inevitable", effet: { pvMax: 10, pmMax: 10, msg: "Votre corps se detend et s'apprete a franchir le seuil." } },
