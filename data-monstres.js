...
const monstresData = [
    ...
    // RANG E - LA SURVIE
    // ==========================================
    { id: "limon_acide", nom: "Limon Acide", rang: "E", theme: "tous", type: "mob", stats: { pv: 30, attaque: 5, defense: 2, agilite: 2 }, comportement: "agressif", description: "Résistance physique élevée, très faible en dégâts.", loot: [{ item: "cristal_mana_e", chance: 0.8, quantite: 1 }] },
    { id: "gobelin_eclaireur", nom: "Gobelin Eclaireur", rang: "E", theme: "foret", type: "mob", stats: { pv: 40, attaque: 7, defense: 3, agilite: 10 }, comportement: "lache", description: "Faible, mais esquive élevée. Jet d'Agilite requis pour le toucher facilement.", loot: [{ item: "cristal_mana_e", chance: 0.6, quantite: 1 }] },
    ...
    { id: "vampire_mineur", nom: "Vampire Mineur", rang: "C", theme: "ruines", type: "mob", stats: { pv: 200, attaque: 30, defense: 14, agilite: 20 }, comportement: "agressif", description: "Se soigne d'un pourcentage des dégâts infliges.", passif: { type: "vol_de_vie", pourcentage: 0.25 }, loot: [{ item: "cristal_mana_c", chance: 0.6, quantite: 1 }] },
    ...
    { id: "chef_tribu_orc", nom: "Chef de Tribu Orc", rang: "C", theme: "ruines", type: "boss", stats: { pv: 480, attaque: 40, defense: 22, agilite: 12 }, comportement: "tactique", description: "Cri de Guerre qui baisse la défense de toute l'escouade adverse.", competenceSpeciale: { nom: "Cri de Guerre", effet: "baisse_defense_groupe", valeur: 0.15 }, loot: [{ item: "cristal_mana_c", chance: 1, quantite: 3 }, { item: "hache_or", chance: 0.3, quantite: 1 }, { item: "cle_donjon_c", chance: 0.25, quantite: 1 }] },
    ...
    { id: "chamane_haut_orc", nom: "Chamane Haut Orc", rang: "B", theme: "ruines", type: "boss", stats: { pv: 900, attaque: 60, defense: 38, agilite: 16 }, comportement: "soigneur_ennemi", description: "Malediction de feu et soin de ses allies.", competenceSpeciale: { nom: "Malediction de Feu", chance: 0.35, effet: "brûlure", duree: 3 }, competenceSecondaire: { nom: "Soin Tribal", effet: "soigne_allies", valeur: 0.15 }, loot: [{ item: "cristal_mana_b", chance: 1, quantite: 4 }, { item: "sceptre_flammes", chance: 0.25, quantite: 1 }, { item: "cle_donjon_b", chance: 0.3, quantite: 1 }] },

    // ==========================================
    // RANG A - L'INVINCIBILITE
    // ==========================================
    { id: "chevalier_mort", nom: "Chevalier de la Mort", rang: "A", theme: "ruines", type: "mob", stats: { pv: 1400, attaque: 95, defense: 70, agilite: 20 }, comportement: "brutal", description: "Immunise a toutes les altérations d'état, haute armure.", immuniteStatuts: true, loot: [{ item: "cristal_mana_a", chance: 0.4, quantite: 1 }] },
    { id: "wyverne", nom: "Wyverne", rang: "A", theme: "foret", type: "mob", stats: { pv: 1300, attaque: 100, defense: 55, agilite: 40 }, comportement: "volant", description: "Seules la magie et les attaques de Ranger font 100 pourcent des dégâts.", resistancePhysique: 0.5, loot: [{ item: "cristal_mana_a", chance: 0.4, quantite: 1 }] },
    { id: "inspecteur_elite", nom: "Inspecteur d'Élite", rang: "A", theme: "tous", type: "humain", stats: { pv: 1200, attaque: 110, defense: 60, agilite: 35 }, comportement: "boss_humain", description: "Dégâts critiques garantis s'il attaque par surprise.", loot: [{ item: "or", chance: 1, quantite: 800 }] },
